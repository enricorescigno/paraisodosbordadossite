  ...
  return <section ref={containerRef} className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-center h-full">
        <div className="container-custom text-center">
          <motion.h1 initial="hidden" animate="visible" variants={titleVariants} className="text-4xl md:text-5xl lg:text-6xl font-serif mb-6 font-thin text-red-700">Paraíso dos Bordados</motion.h1>
          
          <motion.p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-8" initial="hidden" animate="visible" variants={descriptionVariants}>
