    ...
    <section className="py-20 bg-brand-red text-white">
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center">
          <h2 id="newsletter-form-title" className="text-3xl md:text-4xl font-sans font-medium tracking-tight mb-4">
          ...
          >
            ...
            <button 
              ...
              aria-label={isSubmitted ? "Inscrito com sucesso" : "Inscrever na newsletter"}
            >
              {isLoading ? (
                <span className="inline-block w-5 h-5 border-2 border-brand-red border-t-transparent rounded-full animate-spin" aria-hidden="true"></span>
              ) : isSubmitted ? (
