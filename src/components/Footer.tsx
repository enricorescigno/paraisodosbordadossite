  ...
  return <footer className="bg-white text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/categoria/cama-mesa-banho" className="hover:text-red-600 transition-colors">
                    Todos os Produtos
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  ...
                  <a href="mailto:paraisodosbordados65@hotmail.com" className="hover:text-red-600 transition-colors">
      ...
      <div className="bg-red-600 text-white py-4 relative">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          top: 0,
          behavior: 'smooth'
        })} className="flex items-center gap-2 mt-4 md:mt-0" aria-label="Voltar ao topo">
