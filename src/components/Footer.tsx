            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex flex-col">
                  ...
                  <a href="mailto:paraisodosbordados65@hotmail.com" className="text-gray-600 hover:text-brand-red transition-colors duration-200 ml-0 md:ml-6 break-words text-sm md:text-base mx-0">
