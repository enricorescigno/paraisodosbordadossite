          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/produtos" className="hover:text-red-600 transition-colors">
                    Todos os Produtos
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.facebook.com/lojaparaisodosbordados/?locale=pt_BR" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-80 transition-opacity">
                  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" viewBox="0 0 16 16">
