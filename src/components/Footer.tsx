      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {/* Categories */}
            <div>
              <h3 className="font-bold text-xl mb-6 text-brand-red">Todas as Categorias</h3>
            ...
            {/* Institutional */}
            <div>
              <h3 className="font-bold text-xl mb-6 text-brand-red">Institucional</h3>
              <ul className="space-y-3">
                <li>
            ...
            {/* Contact */}
            <div>
              <h3 className="font-bold text-xl mb-6 text-brand-red">Atendimento</h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="text-gray-700">
                ...
                <li className="flex flex-col">
                  ...
                  <a href="mailto:paraisodosbordados65@hotmail.com" className="text-gray-600 hover:text-brand-red transition-colors duration-200 ml-0 md:ml-6">
                    paraisodosbordados65@hotmail.com
                  </a>
                </li>
                
                <li className="pt-4">
                  <p className="font-bold text-gray-800 mb-2">Horário de Atendimento</p>
            ...
            {/* Social Media */}
            <div>
              <h3 className="font-bold text-xl mb-6 text-brand-red">Acompanhe nas Redes</h3>
              <div className="flex gap-4">
                <a 
                  href="https://www.instagram.com/lojaparaisodosbordados/" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.facebook.com/lojaparaisodosbordados" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  aria-label="Facebook" 
                  className="hover:opacity-80 transition-opacity"
      ...
      <div className="bg-brand-red text-white py-4 relative">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            ...
            className="flex items-center gap-2 mt-4 md:mt-0 hover:text-white/80 transition-colors" 
