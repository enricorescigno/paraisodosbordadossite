            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="footer-contact-item">
                  <Phone className="footer-contact-icon w-4 h-4 text-gray-700" />
                  <a href="tel:+558137873206" className="text-gray-600 hover:text-brand-red transition-colors duration-200">
                    (81) 3787-3206
                  </a>
                </li>
                <li className="footer-contact-item">
                  <MessageSquare className="footer-contact-icon w-4 h-4 text-gray-700" />
                  <a href="https://wa.me/5581995970776" className="text-gray-600 hover:text-brand-red transition-colors duration-200">
                    (81) 99597-0776
                  </a>
                </li>
                <li className="flex flex-col">
                  ...
                  <a href="mailto:paraisodosbordados65@hotmail.com" className="text-gray-600 hover:text-brand-red transition-colors duration-200 ml-0 md:ml-6 break-words text-sm md:text-base mx-[2px]">
