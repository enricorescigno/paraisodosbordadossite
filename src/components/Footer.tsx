  ...
  return <footer className="bg-white text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex flex-col">
                  ...
                  <a href="mailto:paraisodosbordados65@hotmail.com" className="text-gray-600 hover:text-brand-red transition-colors duration-200 ml-0 md:ml-6 mx-0">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.facebook.com/lojaparaisodosbordados" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-80 transition-opacity">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 16 16" className="text-gray-700 hover:text-brand-red transition-colors duration-200">
      ...
      <div className="bg-brand-red text-white py-4 relative">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          top: 0,
          behavior: 'smooth'
        })} className="flex items-center gap-2 mt-4 md:mt-0 hover:text-white/80 transition-colors" aria-label="Voltar ao topo">
