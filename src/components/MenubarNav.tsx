      ...
      <NavigationMenu>
        <NavigationMenuList className="flex space-x-6">
          <NavigationMenuItem>
            <Link 
              to="/" 
              className="text-sm text-brand-dark hover:text-brand-red transition-colors duration-200"
            >
              Início
            </Link>
          </NavigationMenuItem>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent className="bg-white rounded-xl p-6 shadow-lg min-w-[400px] grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2 mt-4 pt-4 border-t border-gray-100">
                <Link 
                  to="/produtos" 
                  className="text-brand-red text-sm font-medium hover:text-brand-red/80 transition-colors"
                >
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent className="bg-white rounded-xl p-6 shadow-lg min-w-[400px] grid grid-cols-2 gap-4">
              <div>
                <h3 className="font-medium text-gray-900 mb-3">Vestuário</h3>
                <ul className="space-y-2">
                  <li>
                    <Link 
