...
import { pantufaProducts, vestuarioProducts, banhoProducts } from './products';
...
export const products: Product[] = [...sampleProducts, ...pantufasWithKeywords, ...vestuarioWithKeywords, ...banhoWithKeywords];
